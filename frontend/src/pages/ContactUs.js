    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        ...
        <div className="text-center mb-12 sm:mb-16 animate-fade-in">
          ...
          <div className="h-1 w-20 bg-teal-600 mx-auto mb-6 rounded-full"></div>
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
            Have questions or need help? <span className="text-teal-600 font-semibold">We're here to assist you</span> with your commercial space journey.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-teal-600 rounded-2xl text-white p-8 animate-fade-in animation-delay-300">
